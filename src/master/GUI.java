...
public class GUI extends JFrame implements ActionListener{
	...
	void caiDat(){
		...
		JLabel lbSize=new JLabel("Thu phóng màn hình");
	...
	void showHang() {
		...
		JOptionPane.showConfirmDialog(this, s,"Ô ăn quan",JOptionPane.DEFAULT_OPTION,JOptionPane.PLAIN_MESSAGE);
	}
	void showLuatChoi() {
		String s="Trò chơi kết thúc khi 2 ô quan được ăn bên nào nhiều quan hơn thì bên đó thắng hoặc\n bên nào không còn quan để rải nữa thì trò chơi kết thức";
